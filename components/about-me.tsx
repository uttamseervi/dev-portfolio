  ...
  return (
    <section className="py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Main About Card */}
        <Card className="orange-glow-sm lg:col-span-2 hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] transition-shadow duration-300">
          <CardHeader>
        ...
        {/* Current Focus */}
        <Card className="hover:shadow-[0_0_25px_rgba(249,115,22,0.25)] transition-shadow duration-300">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-3">
              {personalInterests.map((interest, index) => (
                <Badge 
                  key={index} 
                  variant="secondary" 
                  className="flex items-center gap-2 px-3 py-2 text-sm hover:shadow-[0_0_15px_rgba(249,115,22,0.2)] transition-shadow duration-200"
                >
      ...
      <div className="mt-6">
        <Drawer>
          <DrawerTrigger asChild>
            <Button variant="default" className="flex items-center gap-2 hover:shadow-[0_0_20px_rgba(249,115,22,0.3)] transition-shadow duration-200">
